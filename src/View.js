View = function(){
	...
	this.taxomoni = ['Ni pomembno','Bi bilo dobro, ampak','Ne vem, èe mi uspeva','Vèasih mi uspe','Kar dobro mi gre ','To zame drži '];

	this.setTitle = function(){
		let html = '<h1>Poklicna zrelost  <br/><span style = "text-transform:lowercase; font-size: 1.9rem;">- samoevalvacija s pogovorom </span> </h1>';
